...
const Account = () => {
  ...
  return (
    <div className="m-4 mx-auto flex w-[80vw] max-w-[80rem] max-h-[90rem] gap-2 rounded-xl border-2 bg-gray-100 shadow-2xl">
      {/* SIDE BAR */}
      <ul className="w-[30%] space-y-5 rounded-2xl border-r-2 bg-blue-900 p-4 text-slate-100 opacity-80 shadow-xl">
        <li>
        ...
        <li>
          <Link
            to="bookings"
            className={`flex mb-5 w-full items-center gap-4 rounded-full bg-blue-800 px-4 py-2 text-xl shadow-lg transition-all duration-200 ${pathname === "/account/bookings" ? "translate-x-4" : "hover:translate-x-4"}`}
          >
